...
class Interval
  ...
  def overlaps other
    (@upper == other.lower) or (other.lower <= @upper and @upper <= other.upper) or
     (other.lower <= @lower and @lower <= other.upper) or (@lower == other.upper) or equal(other)
  end
